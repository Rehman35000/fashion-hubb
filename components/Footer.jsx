        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="text-sm space-y-3 font-light">
            ...
            <div className="flex gap-4 mt-4">
              <Image className="w-5 h-5 opacity-70 hover:opacity-100 transition-opacity cursor-pointer" src={assets.facebook_icon} alt="facebook" />
              <Image className="w-5 h-5 opacity-70 hover:opacity-100 transition-opacity cursor-pointer" src={assets.instagram_icon} alt="instagram" />
              <Image className="w-5 h-5 opacity-70 hover:opacity-100 transition-opacity cursor-pointer" c alt="twitter" />
            </div>
          </div>
        </div>
      </div>
