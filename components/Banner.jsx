    ...
    <div className="flex flex-col md:flex-row items-center justify-between px-6 md:px-20 py-16 bg-cinnamon-accent my-24 rounded-[2rem] overflow-hidden relative border border-cinnamon-primary/5">
      ...
      <div className="flex flex-col items-start space-y-6 z-10 md:w-1/2">
        ...
        <button 
          ...
          className="group flex items-center justify-center gap-3 px-10 py-3 bg-cinnamon-primary text-white text-[10px] uppercase tracking-widest hover:bg-cinnamon-primary/90 transition-all duration-300 shadow-xl shadow-cinnamon-primary/10"
        >
          Shop the Collection
        </button>
      </div>
      ...
      <div className="md:w-1/2 flex justify-end items-center mt-12 md:mt-0 relative z-10">
        <div className="relative group w-full max-w-xs md:max-w-sm ml-auto">
           <div className="absolute inset-0 bg-white/10 rounded-full blur-2xl group-hover:bg-white/20 transition-all duration-500"></div>
           <Image
            className="w-full relative z-10 drop-shadow-2xl transition-transform duration-700 group-hover:scale-105 rounded-xl object-cover aspect-[3/4]"
            src="/blue-jeans.jpg"
            alt="fashion_banner"
            width={600}
            height={800}
